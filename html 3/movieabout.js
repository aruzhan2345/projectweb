...
document.addEventListener("DOMContentLoaded", () => {
  ...
  console.log(" → [DEBUG] navAuth element:", navAuth);
  const rawFlag = localStorage.getItem("loggedIn");
  console.log(" → [DEBUG] localStorage.loggedIn is:", rawFlag);
  
  if (navAuth) {
    const isLoggedIn = rawFlag === "true";
  ...
  console.log("movieabout.js loaded");
  ...
  fetch(detailsUrl)
    ...
    .then((movie) => {
      console.log("TMDB returned:", movie);
